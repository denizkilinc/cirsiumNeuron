classdef exSlowReceptorMC < markovChain
    %EXSLOWSRECEPTORMC creates excitatory slow receptors to be embedded in neuronMC.
    ...
    properties (SetAccess = private)
        ...
        dRateVectorCross;
        g_ExSlowReceptor = 20*10^-12; %single receptor channel conductance
    ...
    methods
        function thisReceptor = exSlowReceptorMC(stateVector, stateChangeMatrix, parentNeuron)
