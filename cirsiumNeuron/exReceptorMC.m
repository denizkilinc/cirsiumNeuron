classdef exReceptorMC < markovChain
    %EXRECEPTORMC creates excitatory receptors to be embedded in neuronMC.
    ...
    properties (SetAccess = private)
        ...
        dRateVectorCross;
        g_ExReceptor = 20*10^-12; %single receptor channel conductance
    ...
    methods
        function thisReceptor = exReceptorMC(stateVector, stateChangeMatrix, parentNeuron)
            
            thisReceptor = thisReceptor@markovChain(stateVector, stateChangeMatrix);
            
            thisReceptor.parentComponent = parentNeuron;
            
            thisReceptor.numStates = 6;
            thisReceptor.numTransitions = 10;
