% Simulation setup for the results presented in Section 4.1.
% Analysis of feedback inhibition via steady-state semi-analytical method.
...
neuron1 = neuronMC(membraneArea, 0, 0, 1, 'HH', 'Neuron1');
neuron2 = neuronMC(membraneArea, 0, 1, 0, 'HH', 'Neuron2');
...
Tf_est = 0.0190; %this value should be obtained from noiseless transient simulation 
t0 = tend - 2*Tf_est;
hbal = harmonicBalanceSolverMC(ckt, 'nFreq', 400,...
                                  'Tf_est', Tf_est,...
                                  't0', t0,...
                                  'yIdx', 1,...
                                  'currentVariables', currentVariables,...
