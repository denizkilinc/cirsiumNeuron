...
% Analysis of fully connected I network with heterogeneous neurons via steady-state 
...
neuron1 = neuronMC(4*membraneArea, 0, 0, 4, 'HH', 'Neuron1');
neuron2 = neuronMC(2*membraneArea, 0, 0, 4, 'HH', 'Neuron2');
neuron3 = neuronMC(6*membraneArea, 0, 0, 4, 'HH', 'Neuron3');
neuron4 = neuronMC(3*membraneArea, 0, 0, 4, 'HH', 'Neuron4');
neuron5 = neuronMC(10*membraneArea, 0, 0, 4, 'HH', 'Neuron5');

f_vIn = @(t)(cosTapRect(t-0e-3, T_vIn, 1/1000, 1, 1));
iIn1 = currentSource(4*Ihigh, f_vIn, 'Iin1');
iIn2 = currentSource(2*Ihigh, f_vIn, 'Iin2');
iIn3 = currentSource(6*Ihigh, f_vIn, 'Iin3');
iIn4 = currentSource(3*Ihigh, f_vIn, 'Iin4');
iIn5 = currentSource(10*Ihigh, f_vIn, 'Iin5');
