...
% Analysis of fully connected I network via steady-state semi-analytical method.
...
neuron1 = neuronMC(membraneArea, 0, 0, 4, 'HH', 'Neuron1');
neuron2 = neuronMC(membraneArea, 0, 0, 4, 'HH', 'Neuron2');
neuron3 = neuronMC(membraneArea, 0, 0, 4, 'HH', 'Neuron3');
neuron4 = neuronMC(membraneArea, 0, 0, 4, 'HH', 'Neuron4');
neuron5 = neuronMC(membraneArea, 0, 0, 4, 'HH', 'Neuron5');
