...
% Analysis of fully connected I network via transient semi-analytical method.
...
neuron1 = neuronMC(membraneArea, 0, 0, 4, 'MC', 'Neuron1');
neuron2 = neuronMC(membraneArea, 0, 0, 4, 'MC', 'Neuron2');
neuron3 = neuronMC(membraneArea, 0, 0, 4, 'MC', 'Neuron3');
neuron4 = neuronMC(membraneArea, 0, 0, 4, 'MC', 'Neuron4');
neuron5 = neuronMC(membraneArea, 0, 0, 4, 'MC', 'Neuron5');
